...
## ⚠️ CRITICAL: PROJECT CONVENTIONS FIRST

**BEFORE taking any action, you MUST check and follow the project-specific instructions in `.github/instructions/` files.**

**Instruction Priority Hierarchy:**

1. 🔺 **HIGHEST**: Project-specific instructions (`.github/instructions/*.md` files)
2. 🔸 **MEDIUM**: NX workspace conventions (`yarn nx` commands, never `npm`/`npx`)
3. 🔹 **LOWEST**: General AI capabilities and suggestions
