...
export interface CardBlockLoaderProps {
  className?: string;
}

export const CardBlockLoader: FunctionComponent<CardBlockLoaderProps> = ({ className, ...props }) => {
  return (
    <ContentLoader
      speed={2}
      viewBox="0 0 450 490"
...
CardBlockLoader.displayName = 'CardBlockLoader';

export const ListingCardLoader: FunctionComponent = () => {
  return (
...
ListingCardLoader.displayName = 'ListingCardLoader';
